...
const gradientDefString = `
    <defs>
        <linearGradient 
            id='gradient' 
            x1=${constants.PINK_TO_PURPLE_LIGHT_GRADIENT.start.x}
            y1=${constants.PINK_TO_PURPLE_LIGHT_GRADIENT.start.y}
            x2=${constants.PINK_TO_PURPLE_LIGHT_GRADIENT.end.x}
            y2=${constants.PINK_TO_PURPLE_LIGHT_GRADIENT.end.y}
        >
            <Stop offset='0' stop-color='${constants.PINK_TO_PURPLE_LIGHT_GRADIENT.colors[0]}'/>
            <Stop offset='1' stop-color='${constants.PINK_TO_PURPLE_LIGHT_GRADIENT.colors[1]}'/>
        </linearGradient>
    </defs>
`;

export const getTaskIcoXmlStringSvg = (isFillGradient) => {
...
export const getGraphIcoXmlStringSvg = (isFillGradient) => {
    let gradientFill = isFillGradient ? 'url(#gradient)' : '#525252'; 
...
export const getHomeIcoXmlStringSvg = (isFillGradient) => {
    let gradientFill = isFillGradient ? 'url(#gradient)' : '#525252'; 
...
export const getSettingsIcoXmlStringSvg = (isFillGradient) => {
    let gradientFill = isFillGradient ? 'url(#gradient)' : '#525252'; 
...
export const getProfileIcoXmlStringSvg = (isFillGradient) => {
    let gradientFill = isFillGradient ? 'url(#gradient)' : '#525252'; 
...
export const convertColorDataToString = (colorData) => {
    return `rgba(
        ${colorData.rgb[0]}, 
        ${colorData.rgb[1]}, 
        ${colorData.rgb[2]}, 
...
export const svgXmlStringsObject = {
    Stats: getGraphIcoXmlStringSvg,
    Profile: getProfileIcoXmlStringSvg,
    Home: getHomeIcoXmlStringSvg,
    Tasks: getTaskIcoXmlStringSvg,
    Settings: getSettingsIcoXmlStringSvg,
}